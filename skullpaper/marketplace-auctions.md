...
* Auctions can accept **one or more project currencies**, each with its own minimum opening bid — so bidders can compete using different points.
...
* Bidding across different currencies is normalized so cross-currency auctions stay fair.
