...
| games-cryptcrawl.md *(new)*         | Scoundrel-style crawl  | cryptcrawlgame.php (marketing), cryptcrawl.php (game), cryptcrawl-render.php, cryptcrawl-actions.php, ajax/cryptcrawl-action.php, db.php:10451-10805. DHC trait drop pays on DEPTH, not the win: floor 10 of the 15 rooms, read from data-depth on .cc-result (rooms_cleared) rather than the .won class, bands 13/15 so a full escape still pays the placement_3 the win used to. |
