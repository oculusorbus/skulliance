...
* The maximum possible score is **25,000 points**.
* To keep the leaderboard honest, a run must take at least **60 seconds**, and each game uses a one-time validation token issued at the start and consumed on submission.
