...
* Your staked NFTs, displayed **24 per page** with prev/next pagination.
* **Filtering by project/collection** so you can focus on one collection at a time.
* Requires a connected wallet (see [[platform-wallets]]).
