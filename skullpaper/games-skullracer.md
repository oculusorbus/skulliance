...
* A weekly or all-time leader who has a Discord avatar gets it decaled right onto their ghost car's rear grille, in place of that gold trophy/medal icon - so you can see exactly who you're racing, not just which tier. No avatar linked (or your own personal-best ghost, which is always you) just shows the plain 🥇/🏆/🎖️ icon instead.
