...
* **♣♠ Clubs & Spades (2-14, Ace high)** are **enemies**. Fight them bare-handed or with your weapon. Each enemy suit is themed around one animal skull - Clubs are **Cursed Ape**, Spades are **Cursed Ram** - and every Ace/King/Queen/Jack in both suits is one of the collection's rarest WTF-tier pieces, each carrying its own bespoke name (Boombox, Horny, Mardi Gras, Static, Chimera) instead of the suit's default. The 10s in both suits are **Cursed Tiger**, a guest card from the collection's only two Mythic-tier pieces.
