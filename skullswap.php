...
<style>
   ...
   <div class="row" id="row0" style="display:block">    
       <div id="game-container">
           ...
           <div id="game-over-container">
               ...
               <form id="leaderboard-form" action="https://www.skulliance.io/staking/leaderboards.php" method="POST" style="display: none;">
   ...
   class Match3Game {
       ...
       async endGame() {
           ...
           // Clear all remaining matches with debugging
           ...
           // Final cascade to fill any gaps with increased stability
           let moved = true;
           iterations = 0;
