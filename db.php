...
function getCurrentMissions($conn){
	...
	if ($result->num_rows > 0) {
	  ...
	  echo "<th align='center' width='55'>Icon</th><th width='55' align='center'>Project</th><th align='left'>Cost</th><th align='left'>Reward</th><th align='left'>Deployed</th><th align='left'>Success</th><th align='left'>Time Left</th><th align='left'>Status</th><th id='consumable-header' style='display:none'>Item</th>";
	  // output data of each row
	  while($row = $result->fetch_assoc()) {
