...
function getRealms($conn){
	$sql = "SELECT DISTINCT locations.id AS location_id, realms.name AS realm_name, realms.id AS realm_id, users.username AS username, users.avatar AS avatar, balance, projects.name AS project_name, realms_locations.level AS level, locations.name AS location_name FROM realms 
