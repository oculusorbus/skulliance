...
function getRealms($conn){
	$sql = "SELECT DISTINCT locations.id AS location_id, realms.name AS realm_name, users.username AS username FROM realms, users.avatar AS avatar, realms_locations.level AS level, locations.name AS location_name FROM realms 
