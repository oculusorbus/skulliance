			...
			if($diamond_skull == false){
				...
				if(isset($diamond_skull_totals[$row["nfts_id"]])){
					...
					foreach($diamond_skull_totals[$row["nfts_id"]] AS $project_id => $total){
						...
						if($previous_project_id != 0){
							if(($project_id - $previous_project_id) > 1){
								for ($x = 1; $x < ($project_id - $previous_project_id); $x++) {
									$project_rows = $project_rows."<tr><td align='left'>".$project_names[$project_id-$x]."</td><td align='right'>&nbsp;</td><td align='left'>Empty</td></tr>";
								}
							}
						}else{
							if($project_id > 1){
								for ($x = 1; $x < $project_id; $x++) {
									$project_rows = $project_rows."<tr><td align='left'>".$project_names[$x]."</td><td align='right'>&nbsp;</td><td align='left'>Empty</td></tr>";
								}
							}
						}
						$skulls = "";
						...
						$project_rows = $project_rows."<tr><td align='left'>".$project_names[$project_id]."</td><td align='right'>".$skulls."</td><td align='left'>".$status."</td></tr>";
					...
					echo "<table><tr><th width='40%' align='left'>Project</th><th width='40%' align='right'>NFTs</th><th width='20%' align='left'>Status</th></tr>";
					echo $project_rows;
					echo "</table>";
