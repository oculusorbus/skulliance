...
function getCurrentMissions($conn){
	$projects = array();
	$sql = "SELECT missions.id AS mission_id, quest_id, title, projects.name AS project_name, cost, reward, currency, level, missions.created_date, duration, status, COUNT(nft_id) AS total_nfts, SUM(rate) AS success_rate 
