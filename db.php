...
function getCurrentMissions($conn){
	...
	if ($result->num_rows > 0) {
	  echo "<h2 onclick='this.children[0].click()'>Current Missions&nbsp;<img style='padding-right:20px;cursor:pointer;' class='icon' id='".$arrow."' src='icons/".$arrow.".png' onclick='toggleCurrentMissions(this)'/></h2>";
