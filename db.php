		  ...
		  while($row = $result->fetch_assoc()) {
			...
			if($diamond_skull == false){
				...
				if(isset($diamond_skull_totals[$row["nfts_id"]])){
					...
					echo "<br><img style='-webkit-filter: invert(100%) !important;' src='icons/carbon".$carbon_count.".png'/><br><br>";
					...
					echo "<br><img style='-webkit-filter: invert(100%) !important;' src='icons/carbon0.png'/>";
