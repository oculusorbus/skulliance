...
function getCurrentMissions($conn){
	...
	WHERE status = 0 AND missions.user_id = '".$_SESSION['userData']['user_id']."' AND missions.status = '0' GROUP BY missions.id ORDER BY level ASC, missions.created_date ASC LIMIT 3";
