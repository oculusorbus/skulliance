...
function getInventory($conn, $project_id, $quest_id) {
	...
	if ($result->num_rows > 0) {
		...
		echo "<ul>";
		echo "<li class='role no-border-style'><strong>Balance:</strong>&nbsp;".number_format(getBalance($conn, $project_id))." ".$quest["currency"]."</li>";
		echo "<li class='role no-border-style'><strong>Cost:</strong>&nbsp;".number_format($quest["cost"])." ".$quest["currency"]."</li>";
		echo "<li class='role no-border-style'><strong>Reward:</strong>&nbsp;".number_format($quest["reward"])." ".$quest["currency"]."</li>";
