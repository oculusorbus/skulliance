...
function renderDailyReward($day, $currency, $amount, $reward=false) {
	...
	echo "<strong>Day ".$day.":</strong>&nbsp;&nbsp;<img class='icon' src='icons/".$consumables[$day].".png'/>and&nbsp;&nbsp;&nbsp;<img class='icon' src='icons/".strtolower($currency).".png'/> +".$amount." ".preg_replace('/[0-9]+/', '', $currency);
	echo "</li>";
}
