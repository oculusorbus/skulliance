...
function cryptcrawlMinimalGameOverHtml($run, $user_id) {
	...
	<div class="cc-inner">
		<div class="cc-result <?php echo $fell ? 'lost' : 'won'; ?>" data-run-id="<?php echo intval($run['id'] ?? 0); ?>" data-depth="<?php echo intval($run['rooms_cleared'] ?? 0); ?>">
...
<div class="cc-inner">
	...
	<?php elseif ($state === 'game_over'):
		...
		?>
		<div class="cc-result <?php echo $fell ? 'lost' : 'won'; ?>" data-run-id="<?php echo intval($recent_run['id'] ?? 0); ?>" data-depth="<?php echo intval($recent_run['rooms_cleared'] ?? 0); ?>">
			<div class="cc-result-icon"><?php echo $fell ? '<img src="/staking/pwa/skulliance-logo-icon.png" alt="">' : '🏆'; ?></div>
			<div class="cc-result-title"><?php echo $fell ? 'You Died' : 'You Escaped'; ?></div>
			<?php if ($fell): ?>
				<div class="cc-result-image"><img src="images/death.webp" alt="" loading="lazy" onerror="this.parentElement.remove();"></div>
