...
<div class="soldiers-stat-row">
    ...
    <div class="soldiers-stat">
        <span class="soldiers-stat-label">Nightly CARBON</span>
...
<p style="font-size:0.82rem;opacity:0.6;margin-top:12px;">
    The Mine generates <strong><?php echo number_format($info['nightly']); ?> CARBON</strong> per night automatically.
    CARBON is credited to your balance every night and can be crafted into DIAMOND.
    Upgrade the Mine to increase your nightly yield.
</p>
<div style="margin-top:12px;">
    <table class="soldiers-table" style="width:100%;font-size:0.8rem;">
        <tr><th>Level</th><th>CARBON / Night</th></tr>
