...
<div style="margin-top:18px;border-top:1px solid rgba(255,255,255,0.1);padding-top:14px;">
    ...
    <button class="small-button" onclick="claimRealmLogs('<?php echo isset($log_types) ? implode(',', $log_types) : ''; ?>')" style="margin-top:12px;background:#00c8a0;color:#000;width:100%;">Claim All</button>
</div>
<?php else: ?>
