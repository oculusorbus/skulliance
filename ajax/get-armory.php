...
<div style="margin-top:14px;">
    ...
    <p style="font-size:0.78rem;opacity:0.55;margin:6px 0 0;">Each night, your armory rolls <strong><?php echo $drops == 1 ? '1 drop' : '1–' . $drops . ' drops'; ?></strong> at random, then each drop rolls its tier from the table below. Low roll nights are normal.</p>
    <?php
    $tier_odds = array(
