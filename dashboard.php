    ...
    <div class="content">
		...
		<div id="nfts" class="nfts">
			...
			if(isset($_SESSION['userData']['user_id'])){ 
				...
				echo "<p>Please connect a Cardano wallet to view your qualifying NFTs.<br>Once you begin staking your NFTs, you will need to become a Skulliance member before you can claim items from the store.</p>";
			} 
			?>
		</div>
    </div>
