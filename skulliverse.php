...
<script type="text/javascript">
	...
	function openModal(project_id, status, percentage){
		 ...
		 if(project_id != 7){
			 document.getElementById('modal-text').innerHTML = "2x CARBON Rewards Status: "+status.toUpperCase()+"<br><br>Delegations: "+percentage+"%";
		 }else{
		 	document.getElementById('modal-text').innerHTML = "2x DIAMOND Rewards Status: "+status.toUpperCase()+"<br><br>Delegations: "+percentage+"%";
		 }
		 if(project_id == 1){
