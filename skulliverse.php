		...
		<div class="row" id="row1">
			<div class="col1of3">
			    <div class="content">
					...
					<div class="planet crypties"><span class="percentage"><?php echo $percentages[6]; ?>%</span><img class="<?php echo $six; ?>" onclick="javascript:openModal(6, '<?php echo $six; ?>');" src="images/planets/crypties.png"/></div>
					<div class="planet kimo"><span class="percentage"><?php echo $percentages[5]; ?>%</span><img class="<?php echo $five; ?>" onclick="javascript:openModal(5, '<?php echo $five; ?>');" src="images/planets/kimo.png"/></div>
					<div class="planet sinder"><span class="percentage"><?php echo $percentages[4]; ?>%</span><img class="<?php echo $four; ?>" onclick="javascript:openModal(4, '<?php echo $four; ?>');" src="images/planets/sinder.png"/></div>
					<div class="planet hype"><span class="percentage"><?php echo $percentages[3]; ?>%</span><img class="<?php echo $three; ?>" onclick="javascript:openModal(3, '<?php echo $three; ?>');" src="images/planets/hype.png"/></div>
					<div class="planet meed"><span class="percentage"><?php echo $percentages[2]; ?>%</span><img class="<?php echo $two; ?>" onclick="javascript:openModal(2, '<?php echo $two; ?>');" src="images/planets/meed.png"/></div>
					<div class="planet galactico"><span class="percentage"><?php echo $percentages[1]; ?>%</span><img class="<?php echo $one; ?>" onclick="javascript:openModal(1, '<?php echo $one; ?>');" src="images/planets/galactico.png"/></div>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	for (var i = 0; i < planets.length; i++) {
		if(window.innerWidth <= 700){
			planets.item(i).style.paddingTop = (window.innerHeight*1.5)+"px";
		}else{
	...
	function openModal(project_id, status){
		 ...
		 if(project_id != 7){
			 document.getElementById('modal-text').innerText = "2x CARBON Rewards Status: "+status.toUpperCase();
		 }else{
