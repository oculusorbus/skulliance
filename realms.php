									...
									<td width="60%">
										...
										<?php if($levels[$location_id] != 10){ ?>
											...
											<?php 
												...
												if($balance >= $cost){ ?>
													<input class='small-button' type='button' value='Upgrade to Level <?php echo ($levels[$location_id]+1); ?>' onclick='upgradeRealmLocation(this, <?php echo $realm_id;?>, <?php echo $location_id;?>, <?php echo $duration;?>, <?php echo $cost;?>, <?php echo $projects[$location_id]["currency"]; ?>)'>
											<?php
												}else{
												...
												?>
												<br><br>
												<input class='small-button' type='button' value='<?php echo $points_multiplier; ?>x Points Option' onclick='pointsOption(this, <?php echo $realm_id;?>, <?php echo $location_id;?>, <?php echo $duration;?>, <?php echo $cost; ?>)'>
												<?php
										    }else{ 
