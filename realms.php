			...
			if(checkRealm($conn)){
				...
				<?php
					...
					if($activation == "true"){
						...
						echo '<p>Your Realm cannot be reactivated until '.date('F d, Y', strtotime($activation)).'</p>';
					}
				}
			}else{
				?>
				...
				<form action="realms.php" method="post">
					...
					<p id="disclaimer">By creating your realm, you agree to being vulnerable to raids from other realm owners who may attack your realm, damage your locations, and steal your points. You can raid other realms but raid failures also result in damage to your locations. If you anticipate that you are not going to be dedicated to protecting your realm and raiding on a regular basis, don't create a realm. Abandoned realms are a prime target for plundering which can lead to complete poverty and devastation. Realms require core project points as well as DIAMOND to upgrade offense, defense, and transport locations. The more core projects points you have, the stronger your realm will be. Without being able to upgrade all your locations, your ability to attack, defend, and travel may be impeded. Choose your path wisely, there is no turning back.</p>
