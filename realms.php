		...
		<div class="content realm">
			...
			if(checkRealm($conn)){
				...
				<form action="realms.php" method="post">
					...
					<p id="disclaimer">By creating your realm, you agree to being vulnerable to raids from other realm owners who may attack your realm, damage your locations, and steal your points. You can also raid other realms but raid failures also result in damage to your locations. If you anticipate that you are not going to be dedicated to protecting your realm and raiding on a regular basis, don't create a realm. Abandoned realms are a prime target for plundering which can lead to complete devastation. Choose wisely.</p>
