...
<div class="row" id="row0">	
	  ...
	  <div class="main">
		...
		<h2><?php echo checkRealm($conn)?"<span id='realmName'".getRealmName($conn)."</span>&nbsp;<img style='max-width:25px' src='icons/edit.png' class='icon' onclick='editRealmName()'/>":"Realm"; ?></h2>
