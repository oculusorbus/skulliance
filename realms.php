		...
		<div class="content realm">
			...
			if(!checkRealm($conn)){
				...
				<form action="realms.php" method="post">
					...
					<p id="disclaimer">By creating a realm, you agree to being vulnerable to raids from other realm owners which may damage your realm and steal your points. You can also raid other realms but raid failures result in your troops dying and requiring resurrection.</p>
